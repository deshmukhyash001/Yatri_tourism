    ...
    return (
        <>
            <div className='container h-screen flex'>
                {/* Left Section */}
                <div className="secion1 items-center flex gap-7 flex-col py-10 w-1/2 h-screen">
                    ...
                    <div className='inputs -ml-12 flex w-1/2 flex-col gap-2'>
                        ...
                        <label htmlFor="email" className='ml-4 bg-white -mb-5 z-10 w-fit'>E mail</label>
                        <input name='email' type="email" className='rounded-md p-2 outline-0 border-t-emerald-700 border-[0.5px] border-emerald-500 py-3 w-full focus:ring-2 focus:ring-emerald-500 transition-all' />
                        ...
                        <label htmlFor="Password" className='ml-4 bg-white -mb-5 z-10 w-fit'>Password</label>
                        <input type="password" maxLength={6} minLength={6} className='rounded-md p-2 outline-0 border-pink-600 border-[0.5px] border-b-emerald-700 py-3 w-full focus:ring-2 focus:ring-emerald-500 transition-all' />
